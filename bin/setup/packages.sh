...
pkg_gui="argyll avahi-discover cups flatpak fonts-ancient-scripts fonts-cantarell fonts-liberation fonts-mph-2b-damase fonts-sil-andika fonts-symbola fonts-terminus fonts-ubuntu fonts-ubuntu-console gnome-backgrounds gnome-bluetooth gnome-color-manager gnome-disk-utility gnome-keyring gnome-remote-desktop gnome-screenshot gnome-shell gnome-shell-extensions gnome-terminal gnome-themes-extra gnome-tweaks gstreamer1.0-pipewire gstreamer1.0-plugins-base gstreamer1.0-plugins-good gstreamer1.0-pulseaudio gstreamer1.0-tools gstreamer1.0-vaapi gvfs-fuse heif-thumbnailer ipp-usb mplayer mpv nautilus nautilus-extension-burner nautilus-extension-gnome-terminal network-manager-config-connectivity-debian network-manager-gnome ooo-thumbnailer pavucontrol pipewire pulseaudio-module-bluetooth pulseaudio-utils sane-airscan system-config-printer totem totem-plugins torbrowser-launcher ttf-bitstream-vera viewnior vim-gtk3 xarchiver xwayland"
